...
//                 <Grid item xs={3} sm="auto" key={unit} sx={{ textAlign: 'center' }}>
...
//     return (
//         <Box mb={5}>
//             <Typography variant="h4" sx={{ fontFamily: 'Playfair Display', fontWeight: 700, color: 'primary.main', mb: 2, textAlign: 'center' }}>
//                 Some Memories
//             </Typography>
//             <Paper elevation={4} sx={{ position: 'relative', maxWidth: 500, mx: 'auto', height: { xs: 256, sm: 320 }, overflow: 'hidden', borderRadius: 4 }}>
...
// const LoveReasons = () => {
    ...
    //   "That trip to Shillong & Mussoorie, where we officially became friends",
    //   "That you know what I'm thinking with just one look.",
    //   "How you're always honest, especially when I need to hear it.",
    //   "How we can spent time for hours about literally nothing.",
...
//                     <Typography variant="body2" sx={{ color: 'text.secondary', mt: 1 }} onClick={handleOpen}>Click Above!</Typography>
//                 </Box>
...
//                         {isBirthday 
//                             ? "Wishing you a day as beautiful and amazing as you are! Happy Birthday, my bestie!! ❤️"
...
//         }
//         if (!isLetterOpen) {
//             return <Letter onOpen={() => setIsLetterOpen(true)} />;
//         }
//         return (
...
//     const reasons = useMemo(() => [
//       "That trip to Shillong & Mussoorie, where we officially became friends",
//       "Because you always keep me updated with the best gossips 🫢😂",
//       "We both  know what we thinking with just one look",
//       "Because you take a million pictures but still ask me to click more",
//       "How we can spent time for hours about literally nothing",
//       "Knowing you'll always be in my corner, no matter what.",
//     ], []);
